...
//
// Projetos
const hidraProject: ProjectType = {
  type: 'projeto',
  href: '/projects/hidra',
  status: 'ativo',
  card_banner:
...
const cafeComPetProject: ProjectType = {
  type: 'projeto',
...
const papagaioCourse: ProjectType = {
  type: 'projeto',
...
const pinguimProject: ProjectType = {
  type: 'projeto',
...
const raposaProject: ProjectType = {
  type: 'projeto',
...
const micoLeaoProject: ProjectType = {
  type: 'projeto',
...
const arduinoCourse: CourseType = {
  type: 'curso',
  card_banner:
...
const pyTorchCourse: CourseType = {
  type: 'curso',
  card_banner:
